  ...
  const processSteps = [
    {
      ...
      description: "Automated collection of all organic and inorganic materials",
      icon: "🧩",
      detailedInfo: {
        header: "What goes in must come out… as something useful.",
        description: "All solid waste generated by the crew — from food scraps and plastic pouches to used gloves and metal scraps — is collected through sealed chutes or robotic arms directly into the Nature Capsule.",
        process: "Inside, a smart sorting unit uses infrared sensors, conductivity tests, and magnetic separation to automatically divide waste into five streams:",
        streams: [
    ...
    },
    {
      ...
      detailedInfo: {
        ...
        description: "This is where magic happens: converting non-metallic waste into pure carbon dioxide (CO₂), the fuel for life.",
        process: "We use a two-stage hybrid process:",
        stages: [
          {
            title: "🔹 Primary: Catalytic Oxidation (90%)",
            details: "Waste is heated to 300–600°C with a catalyst (Pt/Al₂O₃ or MnO₂). This breaks down organics and plastics cleanly:\nCₓHᵧ + O₂ → CO₂ + H₂O + Heat\nNo flames. No soot. Just clean gas."
          },
          {
            title: "🔹 Backup: Plasma Gasification (10%)",
            details: "For tough or contaminated waste (e.g., perchlorate-laden dust), an electric arc plasma torch reaches 3,000–7,000°C, breaking all molecular bonds. Syngas is re-oxidized to CO₂."
          }
        ],
    ...
    },
    {
      ...
      detailedInfo: {
        ...
        description: "Raw gas from conversion contains impurities like carbon monoxide (CO), VOCs, ash, and microbes — not safe for plants or people.",
        process: "A multi-stage purification system removes everything harmful:",
        stages: [
    ...
    },
    {
      ...
      detailedInfo: {
        ...
        description: "Purified CO₂ is compressed to 30–50 bar and stored in lightweight titanium tanks. A smart control system regulates flow based on:",
        factors: [
    ...
    },
    {
      ...
      detailedInfo: {
        ...
        description: "Using sunlight or LEDs, these living systems turn CO₂ and nutrients into oxygen and edible biomass via photosynthesis.",
        ...
        types: [
          ...
          },
          {
            ...
            details: "Floating plant that doubles daily; high in protein and easy to harvest"
          },
          {
            title: "C4 Crops (wheat, sweet potato):",
            details: "Provide calories and variety in diet; thrive in CO₂-enriched air"
          }
        ],
    ...
    },
    {
      ...
      detailedInfo: {
        ...
        description: "The conversion process generates significant heat — instead of venting it, we capture and reuse it across the system:",
        uses: [
    ...
    },
    {
      ...
      detailedInfo: {
        ...
        description: "Astronauts have better things to do than babysit a recycler.",
                ...
                <div className="absolute top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-sm rounded-xl p-6 border border-green-500/40 shadow-2xl max-h-96 overflow-y-auto">
                  ...
                  <div className="text-sm text-gray-300 space-y-3">
                    ...
                    {step.detailedInfo.process && (
                      <div>
                        <p className="font-semibold text-white mb-2">{step.detailedInfo.process}</p>
                        ...
                        {step.detailedInfo.process && step.detailedInfo.process.includes('\n') && (
                    ...
                    {step.detailedInfo.note && (
                      <div className="bg-green-900/20 border border-green-500/30 rounded p-3 mt-3">
                        <p className="font-semibold text-green-400">{step.detailedInfo.note}</p>
                      </div>
                    )}
                    
                    {step.detailedInfo.specs && step.detailedInfo.specs.length > 0 && (
                      <div className="mt-3">
